...
state in preparation for the reduction. This cleanup step consists of three parts. First, it applies
function extensionality where possible in order to avoid the previously described unsoundness as
...
replacement in the form of the, currently undocumented, `get-model-domain-elements` upon my request.#footnote[https://github.com/cvc5/cvc5/pull/12088]
